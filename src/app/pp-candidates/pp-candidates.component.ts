...
import { Constants } from '../util/constant'; // Adjust the path if needed

const GET_PP_CANDIDATE = Constants.GET_PP_CANDIDATE;

@Component({
  selector: 'app-pp-candidates',
  templateUrl: './pp-candidates.component.html',
  styleUrls: ['./pp-candidates.component.scss'],
  animations: [
...
export class PpCandidatesComponent implements OnInit {
  voteForm: FormGroup;
  voteDataList: any = [];
